...
# c.url.searchengines = {'DEFAULT': 'https://www.google.com/search?q={}', 'google': 'https://www.google.com/search?q={}', 'dict': 'https://dictionary.cambridge.org/dictionary/english/{}', 'thes': 'https://www.freethesaurus.com/{}'}
c.url.searchengines = {
        'DEFAULT': '{}',
        'google': 'https://www.google.com/search?q={}',
        'duck': 'https://duckduckgo.com/?q={}&kax=v176-2&kad=en_US&kp=-2&kz=-1&kn=1&kk=-1&kaj=m&kam=osm&kaq=-1&kap=-1&kao=-1&kau=-1&kae=-1',
        'dict': 'https://dictionary.cambridge.org/dictionary/english/{}',
        'searx': 'https://searx.me/?q={}&language=en-US&time_range=&category_general=on&category_files=on&category_images=on&safesearch=0&theme=simple', 'searx': 'https://searx.me/?q={}&language=en-US&time_range=&category_general=on&category_files=on&category_images=on&safesearch=0&theme=simple',
        'thes': 'https://www.freethesaurus.com/{}'}
...
# config.bind(':', 'set-cmd-text :')
config.bind('s', 'set-cmd-text :set content.proxy socks://localhost:9050/')
...
#config.bind('<Ctrl-o>', 'command-history-prev', mode='command')
...
config.bind('d', 'nop')
config.bind('S', 'set-cmd-text -s :open duck')
config.bind('D', 'set-cmd-text -s :open dict')
config.bind('T', 'set-cmd-text -s :open thes')
